    ...
    <section className="p-8 md:py-0 max-w-7xl mx-auto">
      {country.map((item) => (
        ...
        >
          ...
          <article>
            <h1 className="mb-4 font-bold text-gray-900 dark:text-white text-4xl lg:text-6xl">
              {item.name.official}
            </h1>
            <ul
          ...
          gap-2 text-slate-700 dark:text-gray-400"
            ...
            tracking-wide shadow dark:bg-gray-800 dark:text-gray-400
            text-gray-700"
                  >
                    {border}
                  </li>
            ...
            <Link
              to="/"
              className="inline-block mt-8 bg-white py-2
          px-6 rounded shadow text-gray-700 hover:bg-gray-200
          transition-all duration-200 dark:bg-gray-800 dark:hover:bg-gray-700 dark:text-gray-400 "
            >
              &larr;Back
            </Link>
          </article>
