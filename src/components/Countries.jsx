...
const Countries = () => {
  ...
  useEffect(() => {
    document.title = `Showin All Countries `;
  }, []);
    ...
    <>
      {!countries ? (
        ...
        <section className="container mx-auto p-8">
          ...
          md:items-center md:justify-between mb-7"
          >
            <form
            ...
            >
              <input
               ...
               placeholder-gray-600 w-full shadow rounded outline-none
               dark:text-gray-400 dark:placeholder-gray-400
               dark:bg-gray-800 dark:focus:bg-gray-800 transition-all duration-200"
              />
            </form>
          ...
          <div
            className="grid cols-1 gap-8 md:grid-cols-2
